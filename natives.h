...
namespace PLAYER
{
	...
	//static Ped GET_PLAYER_PED(Player player) { return GET_PLAYER_PED_SCRIPT_INDEX(player); }
...
namespace ENTITY
{
	...
	static void SET_ENTITY_VISIBLE1(Entity entity, BOOL toggle) { invoke<Void>(0xEA1C610A04DB6BBB, entity, toggle); } // 0xEA1C610A04DB6BBB 0xD043E8E1
	...
	static void SET_OBJECT_AS_NO_LONGER_NEEDED(int *p0) { invoke<Void>(0x3AE22DEB5BA5A3E6, p0); } // 0x3AE22DEB5BA5A3E6 0x3F6B949F
	...
	static void SET_ENTITY_VISIBL2(Entity entity, BOOL toggle, BOOL unk) { invoke<Void>(0xEA1C610A04DB6BBB, entity, toggle, unk); } // 0xEA1C610A04DB6BBB 0xD043E8E1
	static void SET_ENTITY_VISIBLE1(Entity entity, BOOL toggle, BOOL unk) { invoke<Void>(0xEA1C610A04DB6BBB, entity, toggle, unk); } // 0xEA1C610A04DB6BBB 0xD043E8E1
