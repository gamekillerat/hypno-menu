...
void YTD()
{
	std::string path = "C:/Hypno/";
	std::string name = "Hypno.ytd";
...
void YTD2() {
	std::string path = "C:/Hypno/Metadata/";
...
int Menu::Settings::visoptionCount = 0;
...
RGBAF Menu::Settings::glowText{ 255, 255, 255, 255, 0 };
...
RGBA Menu::Settings::optionRect{ 0, 0, 0, 170 };
RGBA Menu::Settings::scroller{ 109, 10, 0, 255 };
RGBA Menu::Settings::scrollertop{ 0, 0, 0, 0 };
RGBA Menu::Settings::line{ 255, 255, 255, 255 };
RGBA Menu::Settings::primary{ 255, 0, 0, 255 };
RGBA Menu::Settings::secondary{ 0, 0, 0, 255 };
char* Menu::Settings::ytdtheme = "Hypno1";
...
std::string Menu::Settings::menuend = "HypnoLogo";
...
float Menu::Settings::menuWidth = 0.26f; //0.21f
...
void Menu::drawScrollbar() {
	...
	float space = 0.035f;
	float scroll = ((curopt * (maxopt * space)) / optcnt);
	if (optcnt > maxopt) {
//		Drawing::Rect({ 45, 45, 45, 165 }, { Settings::menuX + 0.112f, Settings::menuY + yyyyy }, { 0.012f, max_options * 0.035f });
		Drawing::Rect(Settings::scroller, { Settings::menuX - Settings::scrollbarWidthIndex, scroll + Settings::menuY + 0.138f }, { 0.008f, 0.035f });
//		GRAPHICS::DRAW_RECT(Settings::menuX - 0.130f, ((((curopt * (maxopt * 0.035f)) / optcnt))) + 0.155f, 0.010f, 0.035f, Settings::scroller.r, Settings::scroller.g, Settings::scroller.b, Settings::scroller.a);
	}
}

bool Menu::Settings::customheaderavailableinmenuoption = false;
...
void Menu::Title(const char * title)
{
	...
	if (Settings::c_enable) {
		...
		else if (Menu::Settings::customheaderavailableinmenuoption) {
			Drawing::Spriter("HypnoCustomHeader", Menu::Settings::ytdtheme, Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); //YTD loader
		}
		else {
			Drawing::Spriter("Hypno", Menu::Settings::ytdtheme, Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); //YTD loader
		}
	}
...
*/
bool Menu::Settings::customspritetest = false;

float Menu::Settings::CustomSpriteX = 0.0f;
float Menu::Settings::CustomSpriteY = 0.0f;

float Menu::Settings::CustomSpriteW = 0.0f;
float Menu::Settings::CustomSpriteH = 0.0f;

float Menu::Settings::CustomSpriteCR = 0.0f;
float Menu::Settings::CustomSpriteCG = 0.0f;
float Menu::Settings::CustomSpriteCB = 0.0f;
float Menu::Settings::CustomSpriteCC = 0.0f;

void Menu::Settings::SpriteTest() {
	if (Menu::Settings::customspritetest) {
		using namespace Menu;
		Drawing::Spriter("Hypno", "IMG1", Settings::CustomSpriteX, Settings::CustomSpriteY, Settings::CustomSpriteW, Settings::CustomSpriteH, 0.f, Settings::CustomSpriteCR, Settings::CustomSpriteCG, Settings::CustomSpriteCB, Settings::CustomSpriteCC);
	}
}

int hotkeyKey = VK_F9; //F12
...
void Menu::addHotkey(std::string name) {
	std::string keypath = "C:/Hypno/keys.ini";
	int key = pressedKey();
	while (key == -1) {
		key = pressedKey();
		WAIT(0);
	...
	if (Settings::currentOption <= 16 && Settings::optionCount <= 16)
	{
		...
		if (Settings::enable_smooth) {
			if (Settings::optionCount >= 16) {
				if (onThis) {
					Drawing::Rect(Settings::scroller, { Settings::menuX, Settings::menuY + (Settings::optionCount)*0.035f + 0.1415f }, { Menu::Settings::menuWidth, 0.035f });
					Drawing::Rect(Settings::scrollertop, { Settings::menuX, Settings::menuY + (Settings::optionCount) * 0.035f + 0.1415f }, { Menu::Settings::menuWidth, 0.0335f });
					if (Settings::enable_scrollbar) {
						if (Settings::optionCount < 17) {
							Drawing::Rect(Settings::scroller, { Settings::menuX - Settings::scrollbarWidthIndex, Settings::menuY + (Settings::optionCount) * 0.035f + 0.1415f }, { 0.008f, 0.035f });
						}
	...
	else if (Settings::optionCount > (Settings::currentOption - 16) && Settings::optionCount <= Settings::currentOption)
	{
		...
		if (Settings::enable_smooth) {
			if (Settings::optionCount >= 16) {
				if (onThis) {
					Drawing::Rect(Settings::scroller, { Settings::menuX, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { Menu::Settings::menuWidth, 0.035f });
					Drawing::Rect(Settings::scroller, { Settings::menuX, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { Menu::Settings::menuWidth, 0.034f });
					if (Settings::enable_scrollbar) {
						if (Settings::optionCount < 17) {
							Drawing::Rect(Settings::scroller, { Settings::menuX - Settings::scrollbarWidthIndex, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { 0.008f, 0.035f });
						}
			...
			if (onThis) {
				Drawing::Rect(Settings::scroller, { Settings::menuX, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16))*0.035f + 0.1415f }, { Menu::Settings::menuWidth, 0.035f });
				Drawing::Rect(Settings::scrollertop, { Settings::menuX, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16))*0.035f + 0.1415f }, { Menu::Settings::menuWidth, 0.0335f });
				if (Settings::enable_scrollbar) {
					if (Settings::optionCount < 17) {
						Drawing::Rect(Settings::scroller, { Settings::menuX - Settings::scrollbarWidthIndex, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { 0.008f, 0.035f });
					}
...
bool Menu::LROption(const char* option, const char* rtext)
{
	using namespace Menu;
	Settings::optionCount++;
	Settings::visoptionCount++;
	bool onThis = Settings::currentOption == Settings::optionCount ? true : false;
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		Drawing::Text(rtext, Settings::integre, { Settings::menuX + (Settings::scrollbarWidthIndex - 0.052f), Settings::menuY + Settings::optionCount * 0.035f + 0.128f }, { Settings::textSize - 0.003f, Settings::textSize - 0.003f }, true);
	else if (Settings::optionCount > Settings::currentOption - Settings::maxVisOptions && Settings::optionCount <= Settings::currentOption)
		Drawing::Text(rtext, Settings::integre, { Settings::menuX + (Settings::scrollbarWidthIndex - 0.052f), Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.128f }, { Settings::textSize - 0.003f, Settings::textSize - 0.003f }, true);
...
bool Menu::GlowOption(const char* option)
{
	using namespace Menu;
	Settings::optionCount++;
	Settings::visoptionCount++;
	...
	if (Settings::currentOption <= 16 && Settings::optionCount <= 16)
	{
		Drawing::Text(option, Settings::glowText, { Settings::menuX - (Settings::scrollbarWidthIndex - 0.02f), Settings::menuY + (Settings::optionCount) * 0.035f + 0.128f }, { Settings::textSize, Settings::textSize }, false);
		Drawing::Rect(Settings::optionRect, { Settings::menuX, Settings::menuY + (Settings::optionCount) * 0.035f + 0.1415f }, { Menu::Settings::menuWidth, 0.035f });
	...
	{
		Drawing::Text(option, Settings::glowText, { Settings::menuX - (Settings::scrollbarWidthIndex - 0.02f), Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.128f }, { Settings::textSize, Settings::textSize }, false);
		Drawing::Rect(Settings::optionRect, { Settings::menuX, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { Menu::Settings::menuWidth, 0.035f });
...
bool Menu::RainbowBool = false;
void Menu::RainbowMenu(bool toggle)
{
	if (Menu::RainbowBool)
	{
		...
		//Scroller
		Menu::Settings::scroller.r = Color[0];
		Menu::Settings::scroller.g = Color[1];
		Menu::Settings::scroller.b = Color[2];
	}
}

bool RainbowBool2 = true;
void GlowingText() 
{
	if (RainbowBool2)
	{
		...
		//Scroller
		Menu::Settings::glowText.r = Color[0];
		Menu::Settings::glowText.g = Color[1];
		Menu::Settings::glowText.b = Color[2];
	}
}
...
bool Menu::MenuBreak(const char* option)
{
	Settings::optionCount++;
	...
	if (Settings::currentOption <= 16 && Settings::optionCount <= 16)
	{
		...
		Drawing::Text(option, Settings::breakText, { Settings::menuX, (Settings::optionCount) * 0.035f + 0.125f }, { 0.3f, 0.3f }, true);
//		Drawing::Text(option, Settings::breakText, { Settings::menuX, Settings::menuY + (Settings::optionCount) * 0.035f + 0.128f }, { 0.3f, 0.3f }, false);
		Drawing::Rect(Settings::optionRect, { Settings::menuX, Settings::menuY + (Settings::optionCount) * 0.035f + 0.1415f }, { Settings::menuWidth, 0.035f });
	...
	{
		Drawing::Text(option, Settings::breakText, { Settings::menuX, (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.125f }, { 0.3f, 0.3f }, true);
//		Drawing::Text(option, Settings::breakText, { Settings::menuX - (Settings::scrollbarWidthIndex - 0.02f), Settings::menuY + (Settings::optionCount) * 0.035f + 0.128f }, { 0.3f, 0.3f }, false);
		Drawing::Rect(Settings::optionRect, { Settings::menuX, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { Settings::menuWidth, 0.035f });
		if (Settings::enable_scrollbar) {
			Drawing::Rect(Settings::optionRect, { Settings::menuX - Settings::scrollbarWidthIndex, Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.1415f }, { 0.01f, 0.035f });
		}
		if (onThis && GetAsyncKeyState(UpPress))
...
void addToggleState(const char *option, bool b00l) {
	...
	if (IsKeyPressed(VK_F11)) {
		INI::WriteBool("C:/Hypno/toggles.ini", b00l, "toggles", ss.str());
	}
}
...
bool Menu::IntToggle(const char * option, bool & b00l, std::function<void()> function, int & _int, int min, int max)
{
	using namespace Menu;
	Toggle(option, b00l);
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		...
		Drawing::Text(Tools::StringToChar("< " + std::to_string(_int) + " >"), Settings::integre, { Settings::menuX + (Settings::scrollbarWidthIndex - 0.052f), Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16)) * 0.035f + 0.128f }, { Settings::textSize - 0.003f, Settings::textSize - 0.003f }, true);
	if (b00l)
	{
		if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
			Drawing::Spriter(Menu::Settings::toggleYTD, Menu::Settings::toggleON, Settings::menuX + (Settings::scrollbarWidthIndex - 0.028f), Settings::menuY + (Settings::optionCount * 0.035f + 0.141f), 0.03f, 0.05f, 0, 255, 255, 255, 255);
...
bool Menu::Float(const char * option, float & _float, int min, int max)
{
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		...
		Drawing::Text(Tools::StringToChar("< " + std::to_string(_float) + " >"), Settings::optionText, { Settings::menuX + (Settings::scrollbarWidthIndex - 0.052f), Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16))*0.035f + 0.128f }, { Settings::textSize - 0.003f, Settings::textSize - 0.003f }, true);
...
bool Menu::IntVector(const char * option, std::vector<int> Vector, int & position)
{
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		...
		Drawing::Text(Tools::StringToChar(std::to_string(Vector[position])), Settings::optionText, { Settings::menuX + (Settings::scrollbarWidthIndex - 0.052f), Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16))*0.035f + 0.128f }, { Settings::textSize - 0.003f, Settings::textSize - 0.003f }, true);
...
bool Menu::StringVector(const char * option, std::vector<std::string> Vector, int & position)
{
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		...
		Drawing::Text(Tools::StringToChar("<" + (Vector[position]) + ">"), Settings::optionText, { Settings::menuX + (Settings::scrollbarWidthIndex - 0.052f), (Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16))*0.035f + 0.128f) }, { Settings::textSize - 0.003f, Settings::textSize - 0.003f }, true);
...
bool Menu::StringVector(const char * option, std::vector<char*> Vector, int & position)
{
	...
	if (Settings::currentOption <= Settings::maxVisOptions && Settings::optionCount <= Settings::maxVisOptions)
		...
		Drawing::Text((char*)ss.str().c_str(), Settings::optionText, { Settings::menuX + (Settings::scrollbarWidthIndex - 0.052f), (Settings::menuY + (Settings::optionCount - (Settings::currentOption - 16))*0.035f + 0.128f) }, { Settings::textSize - 0.003f, Settings::textSize - 0.003f }, true); //0.5 = old
...
void Menu::End()
{
	if (Menu::Settings::displayEnd) {
		...
		int opcount2 = Settings::visoptionCount;
		...
		if (opcount >= 16) {
			...
			Drawing::Spriter("Hypno", Settings::menuend, Settings::menuX, Settings::menuY + ((16 + 1) * 0.035f + 0.136f), 0.02f, 0.035f, 0, Settings::arrow.r, Settings::arrow.g, Settings::arrow.b, Settings::arrow.a);
		}
		else if (opcount > 0) {
			...
			Drawing::Spriter("Hypno", Settings::menuend, Settings::menuX, Settings::menuY + ((Settings::optionCount + 1) * 0.035f + 0.136f), 0.020f, 0.035f, 0, Settings::arrow.r, Settings::arrow.g, Settings::arrow.b, Settings::arrow.a);
		}
	}
}

void Menu::InfoText(const std::string& text)
{
	using namespace Menu;
	if (Settings::displayEnd) {
		int opcount = Settings::optionCount;
		int currop = Settings::currentOption;
		if (opcount >= 16) {
			//if (Settings::enable_scrollbar) { Drawing::Rect(Settings::secondary, { Settings::menuX - Settings::scrollbarWidthIndex, Settings::menuY + 17 * 0.035f + 0.1330f }, { 0.01f, 0.018f }); }
			...
			Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 26 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			Drawing::Rect(Settings::optionRect, { Settings::menuX, Settings::menuY + 18.5f * 0.035f + 0.1365f }, { Settings::menuWidth, 0.05f });
			//Drawing::Rect(Settings::breakrect, { Settings::menuX, 17 * 0.035f + 0.1780f }, { 0.21f, 0.050f });
			//Drawing::Spriter("Hypno", Settings::menuend, Settings::menuX, Settings::menuY + ((16 + 1) * 0.035f + 0.136f), 0.02f, 0.035f, 0, Settings::arrow.r, Settings::arrow.g, Settings::arrow.b, Settings::arrow.a);
		}
		else if (opcount > 0) {
			...
			Drawing::Rect(Settings::optionRect, { Settings::menuX, Settings::menuY + (Settings::optionCount + 2.5f) * 0.035f + 0.1365f }, { Settings::menuWidth, 0.05f });
			//Drawing::Rect(Settings::breakrect, { Settings::menuX, (Settings::optionCount + 1) * 0.035f + 0.1780f }, { 0.21f, 0.050f });
			//Drawing::Spriter("Hypno", Settings::menuend, Settings::menuX, Settings::menuY + ((Settings::optionCount + 1) * 0.035f + 0.136f), 0.020f, 0.035f, 0, Settings::arrow.r, Settings::arrow.g, Settings::arrow.b, Settings::arrow.a);
		if (opcount < 17)
		{
			if (opcount == 1)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 11 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 2)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 12 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 3)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 13 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 4)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 14 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 5)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 15 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 6)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 16 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 7)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 17 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 8)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 18 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 9)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 19 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 10)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 20 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 11)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 21 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 12)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 22 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 13)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 23 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 14)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 24 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
			if (opcount == 15)
			{
				Drawing::Text((text.c_str()), Settings::optionText, { Settings::menuX - 0.087f - (Settings::scrollbarWidthIndex - 0.12f), Settings::menuY + 25 * 0.035f - 0.1365f }, { 0.3f, 0.3f }, false, false, false);
			}
		}
		}
	}
	...
	if (GetTickCount() - Settings::keyPressPreviousTick > Settings::keyPressDelay) {
		if (GetTickCount() - Settings::keyPressPreviousTick2 > Settings::keyPressDelay2) {
			if (GetTickCount() - Settings::keyPressPreviousTick3 > Settings::keyPressDelay3) {
				...
				else if (IsKeyPressed(VK_F5) || CONTROLS::IS_DISABLED_CONTROL_PRESSED(0, ControlScriptRB) && CONTROLS::IS_DISABLED_CONTROL_PRESSED(0, ControlPhoneRight) && Settings::controllerinput) {
					Settings::menuLevel == 0 ? MenuLevelHandler::MoveMenu(SubMenus::mainmenu) : Settings::menuLevel == 1 ? MenuLevelHandler::BackMenu() : NULL;
					prevOption = 1;
					Settings::keyPressPreviousTick = GetTickCount();
				}
...
void Menu::car(std::string texture1, std::string texture2)
{
	YTD3("C:/Hypno/", "Vehicle.ytd");
	using namespace Menu;
	if (Settings::menuX < 0.78f)
	{
		Menu::Drawing::Spriter(texture1, texture2, Menu::Settings::menuX + 0.22f, Settings::menuY + 0.24f, 0.11f, 0.06f, 0, 255, 255, 255, 255);
	}
	else {
		Menu::Drawing::Spriter(texture1, texture2, Menu::Settings::menuX - 0.22f, Settings::menuY + 0.24f, 0.11f, 0.06f, 0, 255, 255, 255, 255);
	}
...
{
	Drawing::Rect(Settings::infocolor, { Settings::menuX - (Settings::scrollbarWidthIndex + 0.080f), Settings::menuY + 0.0620f }, { 0.125f, 0.045f });
	Drawing::Text(title, Settings::count, { Settings::menuX - (Settings::scrollbarWidthIndex + 0.080f), Settings::menuY + 0.0500f }, { 0.375f, 0.375f }, true, false, false);
}

void Menu::PlayerInfoLine(char* text, short line)
{
	if (line == 1) {
		Drawing::Rect(Settings::optionRect, { Settings::menuX - (Settings::scrollbarWidthIndex + 0.080f), Settings::menuY + 0.3340f }, { 0.125f, 17 * 0.042f + -0.213f }); //0.2840f
	...
	Drawing::Text(text, Settings::count, { Settings::menuX - (Settings::scrollbarWidthIndex + 0.070f + 0.070f), Settings::menuY + (line * 0.020f) + 0.085f }, { 0.25f, 0.25f }, false);
}
...
bool Menu::Subtitle(const char * title)
{
	...
	if (Settings::currentOption <= 150 && Settings::optionCount <= 150)
	{
		...
		Drawing::Rect(Settings::breakrect, { Settings::menuX, (Settings::optionCount)*0.035f + 0.1415f }, { Settings::menuWidth, 0.035f });
	}
	else if (Settings::optionCount > (Settings::currentOption - 16) && Settings::optionCount <= Settings::currentOption)
	{

		Drawing::Text(title, Settings::optionText, { Settings::menuX - 0.100f, (Settings::optionCount)*0.035f + 0.128f }, { 0.35f, 0.35f }, false);
		Drawing::Rect(Settings::breakrect, { Settings::menuX,  (Settings::optionCount - (Settings::currentOption - 16))*0.035f + 0.1415f }, { Settings::menuWidth, 0.035f });
	}
	return false;
}
...
void Menu::lightning(int delay, bool fade) {
	...
	if (fade) {
		Drawing::Spriter("Hypno", ln + std::to_string(drawLN(lightningID)), Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy);
	}
	else {
		Drawing::Spriter("Hypno", ln + std::to_string(drawLN(lightningID)), Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy);
	}
...
void Menu::selfInfo(bool toggle) {
	if (toggle || !toggle) { //lol
		...
		char Coord_buf[100]; sprintf_s(Coord_buf, sizeof(Coord_buf), "XYZ: %.3f, %.3f, %.3f", position.x, position.y, position.z, ENTITY::GET_ENTITY_HEADING(playerPed));
		//Health
...
void Menu::TitleFade(const char * title) {
	...
	if (!Menu::Settings::lightning) {
		Drawing::Spriter("Hypno", Menu::Settings::ytdtheme, Settings::menuX, +0.0820f, 0.21f, 0.085f, 0.f, 255, 255, 255, Settings::fadeAlpha); //YTD loader
	}
	else {
...
void Menu::symbols() {
	...
	Drawing::Spriter("Hypno", "HypnoLogo", 0.005f, 0.0f, 0.05f, 0.041f + -0.220f, 0.f, 255, 255, 255, 255);
...
void Menu::Evolve() {
	...
	Drawing::Spriter("Hypno", ln + std::to_string(drawEV(evolveID)), Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy);
...
bool Menu::Settings::evolve2 = false;
int evolveID2 = 1;
void Menu::Evolve2() {
	/*std::string ln = "evolveanim";
	Menu::Drawing::Spriter("Hypno", ln + std::to_string(drawEV(evolveID2)), Menu::Settings::menuX, Menu::Settings::menuY + 0.0820f, Menu::Settings::menuWidth, Menu::Settings::headerHeight, 0.f, 255, 255, 255, Menu::Settings::headerTransparancy);
	std::chrono::milliseconds interval(700000); //700
	if (evolveID2 <= 4) {
		evolveID2++;
	}
	else {
	...
	if (Menu::Drawing::Header2 == true && Menu::Drawing::Header1 == false && Menu::Drawing::Header3 == false && Menu::Drawing::Header4 == false && Menu::Drawing::Header5 == false)
	*/
	{
		static int i2 = 0;
		if (i2 % 40 == 0)
		{
			if (evolveID2 < 4) { evolveID2++; }
			else { evolveID2 = 1; }
		} i2++;
		if (evolveID2 == 1) { Drawing::Spriter("Hypno", "evolveanim1", Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Menu::Settings::headerTransparancy); }
		if (evolveID2 == 2) { Drawing::Spriter("Hypno", "evolveanim2", Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Menu::Settings::headerTransparancy); }
		if (evolveID2 == 3) { Drawing::Spriter("Hypno", "evolveanim3", Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Menu::Settings::headerTransparancy); }
		if (evolveID2 == 4) { Drawing::Spriter("Hypno", "evolveanim4", Settings::menuX, Settings::menuY + 0.0820f, Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Menu::Settings::headerTransparancy); }
	}
}
...
void Menu::Phantom() {
	...
	YTD3("C:/Hypno/title/Forest/", "x1.ytd");
	YTD3("C:/Hypno/title/Forest/", "x2.ytd");
	if (phanID <= 9) {
		ln = "Xforceheader00";
	}
...
std::string Menu::Settings::c_name = "HypnoCustomHeader"; //The YTD Calling from HypnoCustomHeader.ytd in C:\Hypno\.
std::string Menu::Settings::c_pict = ""; //The Image Name In The YTD File Called HypnoCustomHeader.ytd in C:\Hypno\.
...
void Menu::loadCustomHeader() {
	...
	std::string header_2 = "HypnoCustomHeader.ytd";
	YTD3("C:/Hypno/", header_2);
	if (!Menu::Settings::c_animation) {
		Menu::Drawing::Spriter("HypnoCustomHeader", Menu::Settings::c_pict, Menu::Settings::menuX, Menu::Settings::menuY + 0.0820f, Menu::Settings::menuWidth, Menu::Settings::headerHeight, 0.f, 255, 255, 255, Menu::Settings::headerTransparancy);
	}
	else {
...
{
	static int i = 0;
	if (i % 4 == 0) { if (cityID < 58) { cityID++; } else { cityID = 1; } }
	i++;
	if (cityID == 1) { Drawing::Spriter("Hypno", "IMG1", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 2) { Drawing::Spriter("Hypno", "IMG2", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 3) { Drawing::Spriter("Hypno", "IMG3", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 4) { Drawing::Spriter("Hypno", "IMG4", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 5) { Drawing::Spriter("Hypno", "IMG5", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 6) { Drawing::Spriter("Hypno", "IMG6", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 7) { Drawing::Spriter("Hypno", "IMG7", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 8) { Drawing::Spriter("Hypno", "IMG8", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 9) { Drawing::Spriter("Hypno", "IMG9", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 10) { Drawing::Spriter("Hypno", "IMG10", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 11) { Drawing::Spriter("Hypno", "IMG11", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 12) { Drawing::Spriter("Hypno", "IMG12", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 13) { Drawing::Spriter("Hypno", "IMG13", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 14) { Drawing::Spriter("Hypno", "IMG14", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 15) { Drawing::Spriter("Hypno", "IMG15", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 16) { Drawing::Spriter("Hypno", "IMG16", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 17) { Drawing::Spriter("Hypno", "IMG17", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 18) { Drawing::Spriter("Hypno", "IMG18", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 19) { Drawing::Spriter("Hypno", "IMG19", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 20) { Drawing::Spriter("Hypno", "IMG20", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 21) { Drawing::Spriter("Hypno", "IMG21", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 22) { Drawing::Spriter("Hypno", "IMG22", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 23) { Drawing::Spriter("Hypno", "IMG23", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 24) { Drawing::Spriter("Hypno", "IMG24", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 25) { Drawing::Spriter("Hypno", "IMG25", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 26) { Drawing::Spriter("Hypno", "IMG26", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 27) { Drawing::Spriter("Hypno", "IMG27", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 28) { Drawing::Spriter("Hypno", "IMG28", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 29) { Drawing::Spriter("Hypno", "IMG29", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 30) { Drawing::Spriter("Hypno", "IMG30", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 31) { Drawing::Spriter("Hypno", "IMG31", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 32) { Drawing::Spriter("Hypno", "IMG32", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 33) { Drawing::Spriter("Hypno", "IMG33", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 34) { Drawing::Spriter("Hypno", "IMG34", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 35) { Drawing::Spriter("Hypno", "IMG35", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 36) { Drawing::Spriter("Hypno", "IMG36", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 37) { Drawing::Spriter("Hypno", "IMG37", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 38) { Drawing::Spriter("Hypno", "IMG38", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 39) { Drawing::Spriter("Hypno", "IMG39", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 40) { Drawing::Spriter("Hypno", "IMG40", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 41) { Drawing::Spriter("Hypno", "IMG41", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 42) { Drawing::Spriter("Hypno", "IMG42", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 43) { Drawing::Spriter("Hypno", "IMG43", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 44) { Drawing::Spriter("Hypno", "IMG44", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 45) { Drawing::Spriter("Hypno", "IMG45", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 46) { Drawing::Spriter("Hypno", "IMG46", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 47) { Drawing::Spriter("Hypno", "IMG47", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 48) { Drawing::Spriter("Hypno", "IMG48", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 49) { Drawing::Spriter("Hypno", "IMG49", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 50) { Drawing::Spriter("Hypno", "IMG50", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 51) { Drawing::Spriter("Hypno", "IMG51", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 52) { Drawing::Spriter("Hypno", "IMG52", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 53) { Drawing::Spriter("Hypno", "IMG53", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 54) { Drawing::Spriter("Hypno", "IMG54", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 55) { Drawing::Spriter("Hypno", "IMG55", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 56) { Drawing::Spriter("Hypno", "IMG56", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 57) { Drawing::Spriter("Hypno", "IMG57", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
	if (cityID == 58) { Drawing::Spriter("Hypno", "IMG58", Settings::menuX, Settings::menuY + 0.0820, Menu::Settings::menuWidth, Settings::headerHeight, 0.f, 255, 255, 255, Settings::headerTransparancy); }
}
