...
namespace Menu {
	...
	namespace Settings {
		...
		extern bool customspritetest;
		void SpriteTest();
		extern float CustomSpriteX;
		extern float CustomSpriteY;
		extern float CustomSpriteW;
		extern float CustomSpriteH;
		extern float CustomSpriteCR;
		extern float CustomSpriteCG;
		extern float CustomSpriteCB;
		extern float CustomSpriteCC;
		...
		extern bool evolve2;		
		extern bool phantom;
		extern bool customheaderavailableinmenuoption;
	...
	bool MenuBreak(const char* option);
	bool Option(const char* option);
	bool LROption(const char* option, const char* rtext);
	bool IntToggle(const char * option, bool & b00l, std::function<void()> function, int & _int, int min, int max);
	bool Option(const char* option, std::function<void()> function);
	bool GlowOption(const char* option);
	...
	void End();
	void InfoText(const std::string& text);
	void Map(std::string texture1, std::string texture2);
	void car(std::string texture1, std::string texture2);
