...
namespace Features {
	...
	void drawCar(int option, std::string pic);
	...
	extern bool FastMoBool;
	void FastMo(bool toggle);
	...
	void injectnotify(const std::string& text);
